...
export const metadata: Metadata = {
  title: 'Google Review Case Studies',
  description: 'Real Removal Examples. See Proven Outcomes.',
  alternates: {
    canonical: '/google-review-case-studies',
  },
}

export default function GoogleReviewCaseStudiesPage() {
