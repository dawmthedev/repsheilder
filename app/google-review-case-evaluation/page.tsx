...
export const metadata: Metadata = {
  title: 'Free Google Review Case Evaluation',
  description: 'Submit Your Google Review. Get A Confidential Review.',
  alternates: {
    canonical: '/google-review-case-evaluation',
  },
}

export default function GoogleReviewCaseEvaluationPage() {
      ...
      <section className="mx-auto max-w-6xl px-4 py-16">
        <div className="mx-auto max-w-2xl">
          ...
          <h1 className="mt-6 text-center text-4xl font-semibold tracking-tight text-slate-950 md:text-5xl">
            Free Google Review Case Evaluation
          </h1>
